...
vpn_info_dictionary = [
    ...
    },
    {
        ...
        'Дата начала измерений': '01.02.2023',
        'Блокируется': True,
        'Названия в базе на Android': ['VPN Proxy - Super VPN Master'],
        'Названия в базе на IOS': ['VPN Proxy - Super VPN Master']
    },
]
...
dropdown_style = {'font-size': '22px', 'padding-left': '5px', 'padding-right': '5px', 'text-align': 'center'}
dropdown_inside_style = {'background-color':bg_color,' color': 'black', 'text-align': 'left'}
dropdown_as_is_style = {'flex-basis': 'auto'} # , 'width': '24vw'

style_all_filters = {'background-color':bg_color,'display': 'flex','flex-direction': 'column','border-color': '#1f2630',} # ,'width': '99vw'
