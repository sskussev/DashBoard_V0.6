...
def create_time_series(dff):
    ...
    fig.update_layout(hovermode="y unified", paper_bgcolor=paper_bg_color, plot_bgcolor=bg_color, font=dict(family="Roboto", size=10, color=text_color), height=700, xaxis_showgrid=True, yaxis_showgrid=True, showlegend=True) #, xaxis_showgrid=False, yaxis_showgrid=False
