...
app = DjangoDash('without_vpn_rostelecom_mobile')
...
with io.open(settings.STATICFILES_DIRS[0] + '/board/data/bar_3_rostelecom_mobile.json', 'r', encoding='utf-8-sig') as file:
    data = json.load(file)
...
fig = ff.create_gantt(data, colors=colors, index_col='Task', show_colorbar=True,
